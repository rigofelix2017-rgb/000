-- Player XP system with Explorer/Builder/Operator tracks
...
-- XP event log for analytics and audits
...
CREATE INDEX IF NOT EXISTS xp_events_profile_idx ON public.xp_events(profile_id);
CREATE INDEX IF NOT EXISTS xp_events_created_at_idx ON public.xp_events(created_at DESC);

-- Trigger for player_xp updated_at
