-- Daily task templates and player instances
...
-- Per-player daily task instances
...
-- Seed task templates
INSERT INTO public.daily_task_templates (code, title, description, track, xp_reward, target_value) VALUES
  ...
  ('sku_buy', 'Support a Creator', 'Buy or mint 1 SKU item', 'builder', 75, 1),
  ('proximity_chat', 'Say GM', 'Send 1 message in proximity chat', 'explorer', 30, 1)
